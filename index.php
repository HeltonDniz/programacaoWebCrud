...
<div class="container cadastro">
        <form method="POST">
            <legend>
                <h1 text-align="center">Insira os Dados:</h1>
            </legend>
            <fieldset>
                <div>
                ...
                <div>
                    <input type="submit" class="btn btn-primary botoes" value="Enviar">
                    <input type="reset" class="btn btn-primary botoes" value="Limpar Dados"> 
                </div>    
            </fieldset>
        </form>
    </div>
